    ...
    <div class="py-12 w-full mx-auto sm:px-6 lg:px-8 bg-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-black rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-700">
                <div class="flex items-center">
                    <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full p-3 mr-4">
                        <svg class="w-6 h-6 text-black" fill="none" stroke="white" viewBox="0 0 24 24">
            ...
            <div class="bg-black rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-700">
                ...
                <button onClick={{route('profile.edit')}} class="mt-4 w-full bg-gradient-to-r from-yellow-600 to-yellow-800 hover:from-yellow-700 hover:to-yellow-900 text-black font-semibold py-2 px-4 rounded-lg transition transform hover:scale-105">
